    ...
    <div className="space-y-16">
      ...
      <main className="max-w-2xl mx-auto space-y-16 px-4">
        <div className="space-y-4">
          <div className="rounded-lg bg-kitchensKelly-light text-leafyGreen inline-block px-4 py-2 uppercase font-bold text-xl ">Help wanted</div>
          <h1 className="text-5xl font-bold">Seeking Freelance Content Strategists</h1>
